...
The repository includes the scientific report (PDF) formatted as a research paper and R scripts I created for **visualizing genome-wide diversity (Dxy) and ADMIXTURE analysis**. Much of the project’s work involved **extensive preprocessing in Bash** (genome alignment, SNP calling, VCF thinning, windowing, etc.), but the scripts here represent the visualization components I developed to explore divergence and ancestry patterns.  
...
- **Analyses**:  
  ...
  - Genome-wide alignment visualization with **MUMmer/nucmer**  
